...
export const NEWS: NewsItem[] = [
  {
    ...
    titleAr:
      'أوج للابتكار ومستشفى السلطان قابوس يطلقان استوديو الابتكار الصحي',
    date: '2024-11-03',
    ...
    dekAr: 'شراكة لإنشاء استوديو ابتكار متخصص يهدف إلى تعزيز الخدمات الصحية في عُمان عبر حلول طبية متقدمة.',
    featured: true,
    body: [
    ...
    bodyAr: [
      'في خطوة نوعية لتعزيز القطاع الصحي في سلطنة عمان، وقّعت شركة أوج للابتكار اتفاقية تعاون مع مستشفى السلطان قابوس لإنشاء استوديو ابتكار متخصص.',
      'جاء الإعلان عن هذه الشراكة خلال حفل رسمي حضره مسؤولون كبار من الجانبين. ويهدف الاستوديو إلى تعزيز الابتكار في القطاع الصحي وتقديم حلول طبية متقدمة. وتعكس هذه الاتفاقية التزام مستشفى السلطان قابوس بتطوير القطاع الصحي، وتؤكد دور أوج للابتكار في تمكين الابتكار عبر مختلف القطاعات.',
      'وسيعمل الاستوديو على تطوير تقنيات طبية جديدة، وتحسين جودة الخدمات الصحية، ورفع الكفاءة التشغيلية. ومن خلال هذه المبادرة، تُفتح آفاق جديدة للتعاون بين مختلف الأطراف المعنية، بما يعزز القيمة المحلية ويجسّد رؤية عمان المستقبلية في تقديم رعاية صحية متقدمة ومبتكرة.',
    ],
  },
  {
    ...
    titleAr:
      'هاكاثون السفارات: نحو سفارات عمانية ذكية بابتكار دبلوماسي',
    date: '2024-10-22',
    ...
    dekAr: 'أوج تدير وتنفّذ هاكاثون السفارات بالتعاون مع وزارة الخارجية، لتطوير سفارات عُمانية ذكية.',
    featured: true,
    body: [
    ...
    bodyAr: [
      'نفّذت أوج للابتكار بالتعاون مع وزارة الخارجية برنامج هاكاثون السفارات، في محطة مهمة على طريق تحويل السفارات العمانية إلى نماذج ذكية ومستدامة.',
      'استمر البرنامج شهرين، وشارك فيه عدد واسع من موظفي الوزارة والبعثات الدبلوماسية في مختلف أنحاء العالم، وحقق نجاحًا لافتًا من حيث حجم المشاركة وتنوّع الحلول المطروحة وقابليتها للتنفيذ.',
      'وقد دخل عدد من الحلول والمبادرات المنبثقة عن الهاكاثون حيّز التطبيق فعليًا داخل الوزارة، خاصة في مجالات التحوّل الرقمي وإدارة البيانات وتيسير الخدمات القنصلية، بما انعكس على كفاءة العمل وجودة الخدمات المقدَّمة للمواطنين في الخارج.',
      'واعتمد البرنامج منهجية تصميم الابتكار، وركّز على تطوير حلول تقنية قابلة للتطبيق واختبارها في بيئات عمل حقيقية، تحت إشراف مباشر من فرق أوج للابتكار في مختلف مراحله.',
    ],
  },
  {
    ...
    dekAr: 'وزارة التنمية الاجتماعية تتعاون مع أوج للابتكار في تنفيذ ورش تطويرية حول حوكمة المسؤولية الاجتماعية لـ 61 مشاركًا.',
    featured: false,
    body: [
  ...
  },
  {
    ...
    titleAr:
      'إطلاق برنامج هاكاثون السفارات الذكية',
    date: '2024-10-22',
    dateLabel: 'Oct 22, 2024',
    pillar: 'AWJ Innovation',
    ...
    dekAr: 'وزارة الخارجية تطلق أول هاكاثون للسفارات الذكية لتعزيز الابتكار في السفارات العُمانية حول العالم.',
    featured: false,
    body: [
    ...
    bodyAr: [
      'تحت رعاية سعادة خالد بن هاشل المصلحي، وكيل وزارة الخارجية للشؤون الإدارية والمالية، أطلقت وزارة الخارجية الجلسة الافتتاحية لبرنامج "هاكاثون السفارات الذكية"، الذي يهدف إلى تعزيز الابتكار والتحسين المستمر في السفارات العُمانية حول العالم.',
      'ويأتي هذا البرنامج، الأول من نوعه في وزارة الخارجية، ضمن جهود الوزارة لتطوير سفارات ذكية تعتمد على التقنيات الحديثة لرفع الكفاءة والاستدامة في تقديم الخدمات.',
      'ويهدف الهاكاثون إلى توليد مبادرات وأفكار لتطوير نماذج سفارات ذكية توظّف الحلول التقنية الحديثة، مثل الذكاء الاصطناعي، لتحسين جودة الخدمات المقدَّمة للمواطنين في الخارج وتعزيز فاعلية التواصل.',
      'ويتضمن البرنامج عدة مسارات رئيسة، منها التحوّل الرقمي، والأمن السيبراني، وإدارة الموارد، والتواصل الرقمي، مع التركيز على حلول ذكية ومستدامة تلبّي احتياجات السفارات والمواطنين على حد سواء.',
    ],
  },
  {
    ...
    titleAr:
      '"إكسباند"... تحدي أفكار جديد من أسياد لتطوير القطاع اللوجستي',
    date: '2024-09-15',
    ...
    dekAr: 'مجموعة أسياد تطلق تحدي "إكسباند" بإدارة أوج للابتكار لتحفيز الابتكار في قطاع الخدمات اللوجستية العالمي.',
    featured: false,
    body: [
    ...
    bodyAr: [
      'أطلقت مجموعة أسياد تحدي الأفكار "إكسباند"، بإدارة أوج للابتكار، في خطوة تستهدف تحفيز الابتكار داخل المجموعة وإيجاد حلول للتحديات التي يواجهها قطاع الخدمات اللوجستية على المستوى العالمي.',
      'ويتوزّع التحدي على ثلاثة محاور رئيسة، هي: الكفاءة التشغيلية، وهوية المنتج ومدى الوعي به، والمنتجات والخدمات الجديدة.',
      'ويستقطب التحدي أفكارًا مبتكرة من داخل المجموعة وخارجها على حد سواء، سعيًا إلى بلورة حلول عملية قابلة للتطبيق في القطاع اللوجستي، مع تركيز خاص على توظيف التقنيات الحديثة والذكاء الاصطناعي لرفع الكفاءة التشغيلية وابتكار خدمات جديدة.',
    ],
  },
  {
    ...
    titleAr:
      'رحلة "المدرج" الاحتضانية في مطارات عُمان',
    date: '2024-08-30',
    ...
    dekAr: 'برنامج احتضان رائد لمدة 12 شهرًا من مطارات عُمان يحوّل تحديات قطاع الطيران إلى حلول ذات أثر.',
    featured: false,
    body: [
    ...
    bodyAr: [
      'في تجربة رائدة تستهدف تمكين الابتكار في قطاع خدمات الطيران واللوجستيات، اختتمت مطارات عُمان أنشطة حاضنة "المدرج" (Runway Incubator) بعد اثني عشر شهرًا من العمل المكثّف والتوجيه المهني والتجريب المستمر.',
      'وتجاوزت الحاضنة، التي تولّت أوج للابتكار إدارتها، الإطار المعتاد للحاضنات، لتقدّم منصة متكاملة صُمِّمت لرعاية الأفكار وتحويل التحديات التشغيلية في قطاع الطيران إلى حلول واقعية وذات أثر فعلي.',
      'وجسّدت الحاضنة التزام مطارات عُمان بتعزيز القيمة المحلية وتحقيق الاكتفاء المؤسسي الذاتي، من خلال أفكار نابعة من الوعي المحلي وبقيادة خبراء عالميين في مجال ابتكار الطيران.',
      'وضمّ البرنامج ورش عمل مركّزة وجلسات إرشاد، وتمكينًا إداريًا وماليًا وأمنيًا للمشاريع المشاركة، إلى جانب فرص لتقديم حلول ذكية في كفاءة إدارة المطارات وخفض التكاليف المتكررة وأتمتة الأنظمة.',
      'وتُظهر الأرقام حجم الأثر الذي حققته الحاضنة: ٤٤ مشاركًا مسجَّلًا، و١٢ شركة قائمة، و٧ مشاركات دولية، و٥١ مشاركة محلية.',
      'ومن أبرز قصص النجاح التي أفرزتها الحاضنة، حصول فريق "سست" (Sust) على استثمار من صندوق استثماري، في خطوة واعدة نحو تحويل فكرته إلى واقع ذي أثر.',
    ],
  },
  {
    ...
    titleAr:
      'الأكاديمية السلطانية للإدارة تنفّذ برنامج التواصل المجتمعي',
    date: '2024-05-15',
    dateLabel: 'May 15, 2024',
    pillar: 'AWJ Academy',
    dek: 'The Royal Academy of Management conducts Community Communication program for government leaders.',
    dekAr: 'الأكاديمية السلطانية للإدارة تنفّذ برنامج التواصل المجتمعي للقيادات الحكومية.',
    featured: false,
    body: [
    ...
    bodyAr: [
      'نفّذت الأكاديمية السلطانية للإدارة، التي تديرها أوج، برنامج "التواصل المجتمعي" خلال الفترة من ٤ إلى ١٥ مايو، بمشاركة وكلاء الوزارات والمديرين العامّين، سعيًا إلى تمكين القيادات الحكومية من أداء دور فاعل في تعزيز الثقة والتلاحم بين الحكومة والمجتمع، عبر تواصل مؤسسي فعّال متجذّر في الثقافة العُمانية.',
      'ويرسّخ البرنامج لدى القيادات الحكومية عقلية تواصل تضع المجتمع في صميم اهتمامها، بما يمكّنها من نقل التوجّهات والسياسات الحكومية بوضوح ودقّة، فضلًا عن تطوير مهاراتها في إدارة الأزمات بأدوات وتقنيات حديثة تعزّز الاستجابة المجتمعية.',
      'وتناول البرنامج خمسة محاور رئيسة، هي: التواصل المجتمعي وبناء الثقة، وإدارة الأزمات والتعامل مع الرأي العام، وإشراك أصحاب المصلحة، والرصد والتحليل وصناعة المحتوى الرقمي، واستراتيجية التواصل المجتمعي.',
      'ويمثّل البرنامج نموذجًا متقدّمًا في التعلّم التنفيذي، يعكس التزام الأكاديمية بتأهيل القيادات الحكومية وتمكينها من أداء أدوارها المجتمعية بكفاءة، انسجامًا مع أهداف رؤية عُمان ٢٠٤٠.',
    ],
  },
  {
    id: 'aerohack',
    ...
    titleAr:
      'إيروهاك: أكبر هاكاثون للطيران في عُمان',
    date: '2024-03-20',
    ...
    dekAr: 'إيروهاك يجمع المبتكرين ومطوّري التقنية لابتكار حلول لتحديات قطاع الطيران.',
    featured: false,
    body: [
    ...
    bodyAr: [
      'إيروهاك هو أول سباق أفكار من نوعه في عُمان متخصص في تطوير الأفكار لقطاع المطارات، بالتعاون مع أوج للابتكار ودوت نكست فنتشرز. وشكّل الهاكاثون منصة ابتكارية جمعت نخبة من المبتكرين ومطوّري التقنية والمصممين والطلبة والشركات الناشئة لإيجاد حلول مبتكرة لأبرز تحديات القطاع.',
      'التحديات: يشهد قطاع الطيران تطورًا متسارعًا في توظيف أحدث التقنيات. وفي خضم هذا النمو غير المسبوق، يواجه القطاع تحديات كبيرة في مواكبته، من بينها الحاجة إلى حلول مبتكرة تلبّي المتطلبات المتغيرة باستمرار لعمليات المطارات.',
      'الحلول: جاء سباق الأفكار "إيروهاك" منصة مثالية جمعت أصحاب الرؤى لصياغة منظومة الطيران. ومن خلال سلسلة من الأفكار والحلول الرائدة، مكّن الهاكاثون المشاركين من تطوير 16 فكرة مبتكرة لإعادة تصور تجربة المسافرين، وعمليات المطارات، والترفيه، وبرامج الولاء، والاحتفاظ بالعملاء، والأتمتة، والكفاءة، والتنقل خارج المطار.',
      'المحاور الرئيسة: إعادة تصور تجربة المسافر، وإعادة تصور عمليات المطارات، ومستقبل الترفيه في المطارات، والتسويق والاتصال والولاء، وحلول الأتمتة والكفاءة، وحلول الاستدامة والبيئة، والتنقل خارج المطار، والسلامة والأمن والخصوصية.',
    ],
  },
  {
    id: 'nxt-gig-launch',
    ...
    dekAr: 'أوج للابتكار تطلق منصة دوت نكست جيج الرقمية للعمل الحر، لتفتح فرصًا للمستقلين العُمانيين والشركات في الاقتصاد الرقمي.',
    featured: false,
    body: [
  ...
  },
  {
    ...
    titleAr:
      'أول هاكاثون خليجي للتخطيط العمراني',
    date: '2023-10-31',
    ...
    dekAr: '80 شابًا وشابّة من مختلف دول مجلس التعاون الخليجي شاركوا في أول هاكاثون للتخطيط العمراني في عُمان، وطوّروا حلولًا مبتكرة لتحديات التنمية العمرانية.',
    featured: false,
    body: [
    ...
    bodyAr: [
      'نظّمت وزارة الإسكان والتخطيط العمراني، بالتعاون مع أوج للابتكار، أول هاكاثون خليجي للتخطيط العمراني في الفترة من ٢٨ إلى ٣١ أكتوبر ٢٠٢٣، بمشاركة ٨٠ شابًا وشابّة من مختلف دول مجلس التعاون الخليجي، تبادلوا خلاله الأفكار وطرحوا حلولًا مبتكرة تنسجم مع رؤية عُمان ٢٠٤٠ والاستراتيجية العمرانية للوزارة.',
